...
const TIERS: ReadonlyArray<Tier> = [
  {
    id: 'engine',
    badge: '★ THE FLAGSHIP · INFINITY ENGINE',
    title: 'The Infinity Engine',
    pitch:
      'A sovereign game-engine built in its own proprietary language. CSSL-native. Runtime procedural-everything. AI-symbiotic. ¬ external runtime deps. ¬ DRM. Buy in now · lock founder pricing · ride the cadence.',
    price: '$19',
    cadence: '/mo · Builder',
    features: [
      'BUILDER $19/mo · alpha-builds + Sovereign MCP Harness + Discord + LoA-alpha-keys',
      'STUDIO $99/mo · all Builder + 1hr/mo 1:1 + custom-tool/quarter + roadmap-input',
      'FOUNDER $999 lifetime · 50 seats · Builder+Studio forever · names in attestation',
      '8,510 LOC pure CSSL stdlib + engine · 22 csslc fixes/session · 15/15 emit-clean',
      'Cap-witnessed · IFC-labeled · default-deny · sovereign-revoke-anytime',
      '60-day public visible-1440p milestone · prorated refund if missed',
    ],
    cta: 'Buy into the Engine',
    ctaHref: '/products/engine',
    accent: '#c084fc',
    highlight: true,
  },
  {
    id: 'harness',
    badge: 'TIER-2 · DEVELOPER TOOLING',
    title: 'Sovereign MCP Harness',
    pitch:
      'The harness Apocky uses to drive 22 csslc fixes per session. Run your own MCP workspace · point any AI at your codebase. Bundled FREE in the Engine tiers above · sold standalone here for non-Engine customers.',
    price: '$49',
    cadence: '/mo · Starter',
    features: [
      'STARTER $49/mo · 1 user · 5 core tools · email support',
      ...
      'Cap-witnessed · audit-logged · ¬ DRM · ¬ telemetry-by-default',
      '★ Already included in Builder/Studio/Founder Engine tiers above',
    ],
    cta: 'Standalone Harness',
