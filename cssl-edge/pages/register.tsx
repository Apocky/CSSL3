  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Create one revocable account for the Apocky ecosystem." />
      ...
      <AuthFrame mode="register">
        <div className="apx-auth-card">
          <p className="apx-auth-context">One account · explicit capabilities</p>
                ...
                {AUTH_PROVIDERS.filter((provider) => provider.enabled).map((provider) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="apx-provider-state" aria-hidden="true">{loading ? '◐' : '→'}</span>
                    </button>
                  );
                })}
              </div>
