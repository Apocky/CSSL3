...
import PresenceStrip from '@/components/room/PresenceStrip';
import River from '@/components/room/River';
import type { PresenceView, RoomEventView, RoomName } from '@/components/room/types';
