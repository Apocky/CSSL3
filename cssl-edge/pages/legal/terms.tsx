...
const Terms: NextPage = () => (
  ...
  >
    ...
    {/* Added with the privacy section: Apocrypha was absent from both documents while being the
        main thing the site does with what a visitor types. */}
    <h2>Using Apocrypha</h2>
    <p>
      Apocrypha answers questions in the browser. It can be used without an account, within a short
      hourly limit; signing in raises that limit and keeps your conversations across devices. It runs
      on a single machine operated by Apocky, so it can be slow or briefly unavailable, and no
      uptime is promised.
    </p>
    <p>
      Answers are generated by software and can be wrong, incomplete, or out of date. Do not rely on
      one for medical, legal, financial, or other professional advice. What you type is not used to
      train a model. See the <a href="/legal/privacy">privacy policy</a> for what is stored and for
      how long.
    </p>
