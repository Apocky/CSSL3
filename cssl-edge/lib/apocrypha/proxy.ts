...
//
// This module owns four invariants for every private Apocrypha proxy:
// owner authorization, private/no-store responses, a fixed upstream host, and
// bounded requests carrying Cloudflare Access service credentials.
