...
const curatedReviewReceipts: Readonly<Record<string, ReferenceReviewReceipt>> = {
  ...
  'identity-continuity': {
    id: 'ref-audit-20260715-personal-identity-v1', reviewedAt: reviewed, reviewer: 'OpenAI Codex', method: 'section-complete-web-review',
    scope: 'Eric Olson’s complete SEP entry, with characterization, personhood, persistence, evidence, population, ontology, survival, psychological-continuity, fission, too-many-thinkers, animalism, and wider-theme arguments kept distinct.', sourceVersion: 'SEP, substantive revision 2023-06-30',
    coverage: 'Complete entry §§1–8, bibliography, related resources, and author metadata.',
    sourceSnapshots: [{ label: 'SEP Personal Identity HTML', sha256: 'bed25f23b2d088442cddd5f3f9fbe5957585dd2cabd85afbb4761039321a755d' }],
    limitations: ['This is a scholarly survey, not a resolution of the persistence question; it primarily covers the anglophone debate and only points toward non-Western traditions.'],
  },
  testimony: {
    id: 'ref-audit-20260715-testimony-v1', reviewedAt: reviewed, reviewer: 'OpenAI Codex', method: 'section-complete-web-review',
    scope: 'Nick Leonard’s complete SEP survey of reductionist, non-reductionist, hybrid, transmission, generation, evidential, assurance, reliabilist, authority, group, and speech-act accounts of testimony.', sourceVersion: 'SEP, first published 2021-04-01',
    coverage: 'Complete entry §§1–7, notes, bibliography, related resources, and author metadata.',
    sourceSnapshots: [{ label: 'SEP Epistemological Problems of Testimony HTML', sha256: 'f0df3d6d8137e5fb214a34ece62fe6056f1e4c001711319f3dba7e5636851fa4' }],
    limitations: ['The entry expressly does not survey eyewitness law, epistemic injustice, moral testimony, or aesthetic testimony in depth, and it does not validate any particular report.'],
  },
  'explanatory-pluralism': {
    id: 'ref-audit-20260715-scientific-explanation-v1', reviewedAt: reviewed, reviewer: 'OpenAI Codex', method: 'section-complete-archived-web-review',
    scope: 'Woodward and Ross’s complete archived SEP survey of DN, statistical-relevance, causal-mechanical, unificationist, and pragmatic accounts through the end of the twentieth century.', sourceVersion: 'SEP Spring 2022 archive; substantive revision 2021-05-10',
    coverage: 'Complete entry §§1–7.2, notes, bibliography, related resources, and author metadata.',
    sourceSnapshots: [{ label: 'SEP Spring 2022 Scientific Explanation HTML', sha256: '99724dcc59b39fc2b457d6ac73becf25f2505d81b1ca6a26ae074de304cac4b6' }],
    limitations: ['The live URL currently returns not found; the pinned archive is historical and the entry states that its treatment stops at the end of the twentieth century.'],
  },
  falsifiability: {
    id: 'ref-audit-20260715-popper-v1', reviewedAt: reviewed, reviewer: 'OpenAI Codex', method: 'section-complete-web-review',
    scope: 'Stephen Thornton’s complete SEP entry on Popper, including the demarcation proposal, basic statements, conventional decisions, growth of knowledge, probability, verisimilitude, social thought, and critical evaluation.', sourceVersion: 'SEP, substantive revision 2022-09-12',
    coverage: 'Complete entry §§1–11, primary and secondary bibliographies, related resources, and author metadata.',
    sourceSnapshots: [{ label: 'SEP Karl Popper HTML', sha256: 'becd408b2facbef84a7454768392740251dfc7453bc8925d0ab3bbb8318cf5fe' }],
    limitations: ['This is a critical scholarly survey of Popper, not Popper’s primary text and not a consensus demarcation criterion.'],
  },
  'control-theory': {
    id: 'ref-audit-20260715-python-control-v1', reviewedAt: reviewed, reviewer: 'OpenAI Codex', method: 'section-complete-web-review',
    scope: 'The python-control 0.10.2 introduction and linear-systems chapter used to define feedback, state-space representation, design, estimation, stability, and robustness.', sourceVersion: 'python-control 0.10.2 documentation',
    coverage: 'Introduction §§1.1–1.2 and Linear systems §§3.1–3.5, read as complete bounded web pages.',
    sourceSnapshots: [
      { label: 'Introduction HTML', sha256: 'f7336edbb65729a787d8f0c5f458de1b32edcc4fab17cdc472eb834c09db0eff' },
      { label: 'Linear systems HTML', sha256: '434c2a1ce6589b2a3dc1592b9b9ff5f008af9e1342ffb32dc378a683ee2602ac' },
    ],
    limitations: ['This bounded software-documentation review does not audit nonlinear-control chapters, prove a psychological homeostasis model, or identify Shawn-specific state variables.'],
  },
  'causal-intervention': {
    id: 'ref-audit-20260715-dowhy-intro-v1', reviewedAt: reviewed, reviewer: 'OpenAI Codex', method: 'section-complete-web-review',
    scope: 'DoWhy’s complete main introduction page used for the causal-task, graph-assumption, identification, estimation, and refutation boundaries.', sourceVersion: 'DoWhy main documentation accessed 2026-07-15',
    coverage: 'Complete Introduction page, especially Supported causal tasks and Testing the validity of a causal analysis.',
    sourceSnapshots: [{ label: 'DoWhy Introduction HTML', sha256: '16df5ea3a6b95f92503c1cf78fab446484074d0b558c7631117889dac1d98f66' }],
    limitations: ['The reviewed introduction describes a workflow and its assumptions; it neither validates a supplied causal graph nor replaces experimental evidence.'],
  },
  'process-mining': {
    id: 'ref-audit-20260715-pm4py-overview-v1', reviewedAt: reviewed, reviewer: 'OpenAI Codex', method: 'section-complete-web-review',
    scope: 'PM4Py’s complete official overview page used for event-data discovery, case and variant inspection, performance views, and conformance checking.', sourceVersion: 'PM4Py overview accessed 2026-07-15',
    coverage: 'Complete Overview page from Process Map through Conformance Checking and Algorithm breadth.',
    sourceSnapshots: [{ label: 'PM4Py Overview HTML', sha256: '8c3a0564cdcb93116a0923b0c2dfba75fb653108b18abab7406391ba98d34fa3' }],
    limitations: ['The reviewed overview does not establish source completeness, semantic correctness, or the behavior of every listed algorithm.'],
  },
};
...
const curatedContentHashes: Readonly<Record<string, string>> = {
  ...
  'identity-continuity': 'sha256:bed25f23b2d088442cddd5f3f9fbe5957585dd2cabd85afbb4761039321a755d',
  testimony: 'sha256:f0df3d6d8137e5fb214a34ece62fe6056f1e4c001711319f3dba7e5636851fa4',
  'explanatory-pluralism': 'sha256:99724dcc59b39fc2b457d6ac73becf25f2505d81b1ca6a26ae074de304cac4b6',
  falsifiability: 'sha256:becd408b2facbef84a7454768392740251dfc7453bc8925d0ab3bbb8318cf5fe',
};
...
const curatedLocators: Readonly<Record<string, string>> = {
  ...
  'identity-continuity': 'Complete entry §§1–8; especially §1 question taxonomy, §§3–4 persistence accounts, §5 fission, §§6–7 thinking-animal and animalist objections',
  testimony: 'Complete entry §§1–7; especially §1 reductionism, §2 transmission/generation, §§3–4 evidence and dependence, §5 authority, §7 testimony definitions',
  'explanatory-pluralism': 'Spring 2022 archived entry, complete §§1–7.2; especially §2.5 counterexamples, §§3–6 rival models, and §7.2 disciplinary variation',
  falsifiability: 'Complete entry §§1–11; especially §§3–4 demarcation, basic statements, convention, and §11 critical evaluation',
  'control-theory': 'python-control 0.10.2 User Guide §§1.1–1.2 and 3.1–3.5; complete bounded pages',
  'causal-intervention': 'DoWhy Introduction; especially Supported causal tasks and Testing the validity of a causal analysis; complete bounded page',
  'process-mining': 'PM4Py Overview; Process Map through Conformance Checking and Algorithm breadth; complete bounded page',
};
...
const seeds: readonly TopicSeed[] = [
  ...
  {
    slug: 'control-theory', aliases: ['homeostasis'], title: 'Control theory and homeostasis', domain: 'modeling-methods', mode: 'formal', role: 'R3', creators: ['Python Control Systems Library contributors'], date: 'current documentation', publisher: 'python-control project', url: 'https://python-control.readthedocs.io/en/0.10.2/intro.html', authority: 'Official computational documentation for feedback, explicit state-space models, control design, estimation, stability, and robustness.', orientation: 'Control theory studies how state, feedback, disturbances, and interventions shape system behavior over time.', prerequisites: ['linear algebra', 'differential equations'], technical: 'A state-space model explicitly defines states, inputs, outputs, and dynamics; control and estimation then operate under stated model and signal assumptions. “Homeostasis” becomes testable only after targets, disturbances, measurements, and controllers are operationalized.', shawnUse: 'The recurrent-attractor model uses control language to ask how artifact-making and model revision restore or transform state.', supports: 'Formal analysis and simulation of an explicitly specified dynamical model.', boundary: 'The documentation does not identify Shawn-specific state variables, validate a psychological homeostasis mechanism, or promote a narrative feedback analogy into measured causation.', counter: 'Narrative sequence may fit a feedback diagram without the quantities needed to estimate it.', revision: 'Revise when time-series measurements reject the proposed state variables or feedback signs.',
  },
  {
    slug: 'causal-intervention', aliases: ['structural-causal-models', 'counterfactuals'], title: 'Causal intervention and refutation', domain: 'modeling-methods', mode: 'computational', role: 'R3', creators: ['PyWhy contributors'], date: 'current documentation', publisher: 'PyWhy', url: 'https://www.pywhy.org/dowhy/main/user_guide/intro.html', authority: 'Official documentation for causal questions, domain-modeled graphs, identification, estimation, and refutation workflows.', orientation: 'Causal claims require assumptions about interventions and confounding that ordinary association does not provide.', prerequisites: ['probability', 'directed acyclic graphs'], technical: 'The documented workflow makes the causal graph and estimand explicit before estimation. Its refutation stage challenges assumptions and result robustness; it does not prove that the graph is true.', shawnUse: 'Episode cards separate variables, rivals, external checks, and negative controls before making causal claims.', supports: 'Transparent causal assumptions and bounded estimation under a specified model.', boundary: 'Downstream results depend on the supplied domain graph; software output cannot validate an unmeasured graph or manufacture randomized evidence.', counter: 'A descriptive longitudinal account may be more honest than an underidentified causal model.', revision: 'Revise if negative controls, alternate graphs, or intervention data reverse the estimate.',
  },
  {
  ...
  {
    slug: 'process-mining', aliases: ['petri-net-conformance'], title: 'Process mining and conformance', domain: 'modeling-methods', mode: 'computational', role: 'R3', creators: ['PM4Py contributors'], date: 'current documentation', publisher: 'Fraunhofer FIT', url: 'https://processintelligence.solutions/pm4py', authority: 'Official overview of discovery, case and variant inspection, performance views, and conformance checking over event data.', orientation: 'Process mining compares recorded event flows with candidate workflow models and exposes deviations or hidden loops.', prerequisites: ['event logs', 'Petri nets'], technical: 'The reviewed overview supports discovery, case and variant inspection, temporal and performance analysis, and deviation checks. Every result remains conditional on the event data, identifiers, and model supplied.', shawnUse: 'It can test whether the idealized reasoning chain matches actual time-ordered work rather than retrospective narration.', supports: 'Discovery and conformance-oriented analysis for a defined event dataset and process model.', boundary: 'The overview does not guarantee archive completeness or semantic correctness; missing events can create false deviations or erase undocumented work.', counter: 'Close reading may recover semantic transitions that timestamp-only mining misses.', revision: 'Revise after source-complete event extraction and seeded valid/invalid trace tests.',
  },
  {
  ...
  {
    slug: 'identity-continuity', aliases: ['personal-identity'], title: 'Personal identity: characterization, persistence, and evidence', domain: 'philosophy-epistemology', mode: 'philosophical', role: 'R2', creators: ['Eric T. Olson'], date: '2023', publisher: 'Stanford Encyclopedia of Philosophy', url: 'https://plato.stanford.edu/entries/identity-personal/', authority: 'Critical scholarly survey that distinguishes characterization, personhood, persistence, evidence, population, ontology, and what matters in survival; it reports no consensus on personal ontology.', orientation: '“Who am I?”, “what is a person?”, “what makes a later being numerically me?”, and “what evidence identifies me?” are different questions and cannot be answered by one continuity slogan.', prerequisites: ['metaphysics', 'philosophy of mind'], technical: 'Psychological-continuity, brute-physical, hybrid, and anticriterialist views face memory circularity, transitivity, fission, branching, too-many-thinkers, animalist, and temporal-parts problems. Evidence for identity must not be confused with persistence conditions.', shawnUse: 'The atlas models recurring characterization and psychological connectedness without claiming that its archive, model, or executable copy settles Shawn’s numerical persistence or personhood.', supports: 'The taxonomy of identity questions, rival persistence accounts, their principal objections, and the distinction between evidence for identity and what identity consists in.', boundary: 'The survey does not select a winning criterion, establish narrative identity as persistence, prove cross-substrate migration, or show that a model copy is numerically Shawn.', counter: 'The recurrent-attractor model may explain characterization and practical concern while remaining silent—or being wrong—about numerical identity; animalist, brute-physical, anticriterialist, and indeterminacy views remain live.', revision: 'Revise if the atlas conflates characterization with persistence, treats memory as sufficient without branching and circularity controls, or gains evidence discriminating psychological, physical, hybrid, or anticriterialist accounts.',
  },
  {
    slug: 'testimony', aliases: ['epistemology-of-testimony'], title: 'Testimony: justification, transmission, authority, and dependence', domain: 'philosophy-epistemology', mode: 'philosophical', role: 'R2', creators: ['Nick Leonard'], date: '2021', publisher: 'Stanford Encyclopedia of Philosophy', url: 'https://plato.stanford.edu/entries/testimony-episprob/', authority: 'Scholarly survey of unresolved debates over reductionism, presumptive entitlement, knowledge transmission and generation, evidence, assurance, reliability, authority, groups, and the speech act of testimony.', orientation: 'Testimony is indispensable but not epistemically uniform: justification depends on the proposition, speaker, hearer, defeaters, reliability, authority relation, and theory of testimonial entitlement.', prerequisites: ['epistemology', 'social knowledge'], technical: 'Reductionist, non-reductionist, and hybrid views disagree about positive reasons; transmission and generation cases separate a speaker’s knowledge from a hearer’s; evidential, assurance, reliabilist, individualist, and anti-individualist accounts locate justification differently. Authoritative testimony need not preempt all contrary reasons.', shawnUse: 'The atlas treats Shawn as the primary authority on what he reports intending and experiencing, while separately typing memory, authorship, external-causation, mechanism, and generalization claims and preserving possible defeaters.', supports: 'The legitimacy and complexity of testimonial knowledge, plus a vocabulary for competence, defeaters, authority, dependence, and speaker/hearer contributions.', boundary: 'The survey does not validate any particular report, provide a general rule that sincerity entails truth, or specifically establish first-person phenomenology as incorrigible; it expressly leaves eyewitness law and epistemic injustice largely outside scope.', counter: 'A report can be sincere yet mistaken, framed, reconstructed, or outside the speaker’s competence; conversely, demanding independent proof for every first-person report can enact testimonial injustice and erase the very phenomenon under study.', revision: 'Revise a claim when contemporaneous artifacts, competence limits, contradictions, independent witnesses, incentives, or other proposition-specific defeaters change its testimonial standing.',
  },
  {
    slug: 'explanatory-pluralism', aliases: ['plural-explanation'], title: 'Scientific explanation and model pluralism', domain: 'philosophy-epistemology', mode: 'philosophical', role: 'R2', creators: ['James Woodward', 'Lauren Ross'], date: '2021', publisher: 'Stanford Encyclopedia of Philosophy', url: 'https://plato.stanford.edu/archives/spr2022/entries/scientific-explanation/', authority: 'Pinned scholarly survey of deductive-nomological, statistical-relevance, causal-mechanical, unificationist, and pragmatic accounts, their counterexamples, and the unresolved prospect of domain-sensitive pluralism.', orientation: 'Truth, evidence, description, prediction, causation, and explanation are not interchangeable; different models capture different relevance relations and each has known failures.', prerequisites: ['philosophy of science'], technical: 'DN entailment and laws, statistical relevance, causal processes, unification, contrastive pragmatics, causal versus non-causal explanation, and disciplinary variation impose different structures. The surveyed models are universalist aspirations, not a settled proof that one form fits every domain.', shawnUse: 'Lens rotation keeps causal, computational, phenomenological, symbolic, historical, and fictional accounts separate, then asks which explains a specified contrast and which adds discriminating evidence rather than decorative compatibility.', supports: 'The existence of materially different explanation models, their principal counterexamples, the distinction between explanation and description, and the open problem of domain-sensitive integration.', boundary: 'The source does not say that all explanations are equally good, mutually compatible, or jointly true; its coverage stops at the end of the twentieth century and the former live URL is no longer available.', counter: 'Plural lenses can become immunizing bureaucracy: if a lens supplies no explanatory relevance, contrast, test, or unique understanding, it should be removed rather than preserved for symmetry.', revision: 'Revise when a lens adds no unique explanatory relation or when newer scholarship supplies a better domain-specific account; never use plurality to prevent comparative judgment.',
  },
  {
    slug: 'falsifiability', aliases: ['refutation'], title: 'Popperian falsifiability and critical model testing', domain: 'philosophy-epistemology', mode: 'philosophical', role: 'R2', creators: ['Stephen Thornton'], date: '2022', publisher: 'Stanford Encyclopedia of Philosophy', url: 'https://plato.stanford.edu/entries/popper/', authority: 'Critical scholarly account of Popper’s demarcation criterion, basic statements, conventional decisions, corroboration, knowledge growth, and major objections.', orientation: 'Falsifiability is Popper’s criterion for distinguishing empirical science from non-science, not a claim that non-science is meaningless or that one apparent anomaly mechanically destroys a theory.', prerequisites: ['philosophy of science', 'hypothesis testing'], technical: 'Universal claims prohibit possible observations; singular existential basic statements can contradict them, but basic statements must be intersubjectively testable and are accepted through methodological convention. Logic permits modus-tollens refutation; practice must handle measurement, auxiliary assumptions, reproducibility, ad hoc rescue, and theory comparison.', shawnUse: 'ZEROES predeclares demotion conditions, preserves failures, and distinguishes a logical countercase from the methodological decision that the observation, apparatus, bridge dictionary, and auxiliary assumptions survived scrutiny.', supports: 'Risky predictions, potential falsifiers, intersubjective testing, provisional corroboration, and criticism of ad hoc modifications made only to evade refutation.', boundary: 'The entry does not establish falsifiability as a sufficient account of scientific quality, endorse naïve one-shot refutation, or make an analogy scientific merely because a falsifier is written down.', counter: 'Duhem-style auxiliary dependence, Kuhnian practice, probabilistic theories, measurement development, confirmation, Bayesian comparison, and Popper’s own conventional decisions limit simple falsificationism.', revision: 'Revise if thresholds move after results, observations are treated as incorrigible, auxiliaries are changed solely to save the favored model, or counterevidence is neither reproduced nor methodologically adjudicated.',
  },
  {
