...
export const ACCOUNT_DIAGNOSTIC_CODES = {
  ...
  ACCOUNT_ADMISSION_PENDING: entry('reply', 'Your message is saved and waiting for Apocrypha. Retry keeps the same request.'),
  ACCOUNT_PENDING_STORAGE_UNAVAILABLE: entry('client', 'Your message could not be saved safely on this device. It has not been sent.'),
  ACCOUNT_PENDING_CONFLICT: entry('client', 'Another saved message is awaiting a reply. Refresh this conversation before sending again.'),
