  ...
  const roomContent = {
    north: {
      ...
      notes: [
        ...
        ['study', 'Laboratory response preview.', '“The second song enters at 00:52—brighter, descending.” This is authored sample copy, not a live response.'],
      ],
      scopeArtifact: 'clip 00:41–01:12 only',
      scopePurpose: 'name the second birdsong',
      scopeDuration: 'this session',
      offerRoute: 'Apocky → selected clip → invited participant',
    ...
    nook: {
      ...
      notes: [
        ...
        ['study', 'Laboratory response preview.', '“The river returns as a boundary, not a destination.” This is authored sample copy, not a live response.'],
      ],
      scopeArtifact: 'paragraph 2 only',
      scopePurpose: 'trace the recurring river image',
      scopeDuration: 'this session',
      offerRoute: 'Apocky → selected paragraph → invited participant',
    ...
    workbench: {
      ...
      notes: [
        ...
        ['study', 'Laboratory response preview.', '“The hinge is agency: the door remains yours to open.” This is authored sample copy, not a live response.'],
      ],
      scopeArtifact: 'fragment 04 only',
      scopePurpose: 'test the boundary wording',
      scopeDuration: 'this session',
      offerRoute: 'Apocky → selected fragment → invited participant',
