...
interface TurnResponse {
  ...
  duplicate_commit_blocker?: unknown;
}
...
const DUPLICATE_COMMIT_BLOCKER = 'backend_turn_contract_has_no_idempotency_field';
...
export function ChatThread() {
  ...
  const send = useCallback(async () => {
    ...
    if (!text || waiting || !conversationId) return;
    ...
    try {
      ...
      if (
        ...
        || body.duplicate_commit_protection !== 'blocked'
        || body.duplicate_commit_blocker !== DUPLICATE_COMMIT_BLOCKER
      ) {
  ...
  return (
    <section className="v2-chat" aria-label="Apocrypha V2 chat">
      ...
      <style jsx>{`
        ...
        .v2-error { color:#ffb8bd; background:#2a151b; border:1px solid #5b2933; }
