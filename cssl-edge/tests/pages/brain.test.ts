...
assert.match(experience, /Explore your saved records and their source links/, 'memory help must explain the bounded saved-record source');
...
assert.match(experience, /message will be saved on this device until it can be delivered/, 'offline composition must explain durable deferred delivery');
assert.match(experience, /replies come from your desktop/i, 'mobile topology must name desktop reply authority');
