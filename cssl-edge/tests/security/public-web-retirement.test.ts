...
import { isRetiredWebRuntimeRequest, middleware } from '@/middleware';
...
async function main(): Promise<void> {
  ...
  console.log('public web retirement : OK · neutral 404 boundary + zero production runtime transport');
}
