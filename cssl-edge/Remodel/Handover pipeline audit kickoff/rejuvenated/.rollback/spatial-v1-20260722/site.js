(() => {
  ...
  function motionIsOff() {
    ...
    if (userMotionChoice === 'on') return false;
  ...
  function syncMotionState() {
    ...
    motionToggles.forEach((toggle) => {
      ...
      toggle.setAttribute('aria-label', isOff ? 'Resume ambient motion' : 'Pause ambient motion');
  ...
  const onMotionPreferenceChange = () => {
    if (userMotionChoice === null) syncMotionState();
  };
