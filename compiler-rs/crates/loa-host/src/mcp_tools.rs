...
mod tests {
    ...
    #[test]
    fn tools_list_returns_27_tools() {
        ...
        //   render.tour, render.diff_golden) = 27 total.
        let reg = tool_registry();
        assert_eq!(reg.len(), 27, "must have exactly 27 tools");
    ...
    fn tools_list_handler_count_matches_registry() {
        ...
        // 17 baseline + 7 render-control + 3 test-apparatus = 27.
