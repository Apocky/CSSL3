...
mod tests {
    ...
    #[test]
    fn tools_list_returns_80_tools() {
        ...
        // = 80 total.
        let reg = tool_registry();
        assert_eq!(reg.len(), 80, "must have exactly 80 tools");
    ...
    fn tools_list_handler_count_matches_registry() {
        ...
        // + 3 cfer (T11-LOA-FID-CFER) + 32 sensory (T11-LOA-SENSORY) = 80.
        assert_eq!(v["count"], 80);
