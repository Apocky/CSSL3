...
// ════════════════════════════════════════════════════════════════════
// § I> per W13-2 : weapons-tick = seeded-RNG · replay-bit-equal across hosts
// § I> splitmix64 chosen ∵ : tiny · stateless-after-seed · Copy · canonical
//      reference impl (Vigna 2014 ; public-domain) ; matches sibling
//      cssl-host-combat-sim::seed semantics for cross-crate determinism.
...
/// inside a `WeaponState` checkpoint and resume later.
