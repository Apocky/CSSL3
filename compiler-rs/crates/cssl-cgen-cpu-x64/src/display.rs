...
//!   Tests build a known MIR fn, run it through [`crate::select_function`],
...
//!
//!   Conventions :
//!     - Block labels use the canonical [`crate::BlockId`] display form (`bb0`).
...
use crate::func::X64Func;
use crate::inst::{X64Inst, X64Term};
...
mod tests {
    ...
    use crate::func::{X64Func, X64Signature};
    use crate::inst::{X64Imm, X64Inst, X64Term};
    use crate::vreg::X64Width;

    #[test]
    fn format_empty_func_void_void() {
        let mut f = X64Func::new("noop", X64Signature::empty());
        f.set_terminator(
            crate::inst::BlockId::ENTRY,
    ...
    fn format_inst_arithmetic_three_address() {
        ...
        f.push_inst(crate::inst::BlockId::ENTRY, X64Inst::Mov { dst, src: p0 });
        f.push_inst(crate::inst::BlockId::ENTRY, X64Inst::Add { dst, src: p1 });
        f.set_terminator(
            crate::inst::BlockId::ENTRY,
            X64Term::Ret {
                operands: vec![dst],
    ...
    fn format_loads_and_stores() {
        ...
        f.push_inst(
            ...
            X64Inst::Load {
                dst: v,
                addr: crate::inst::MemAddr::base(ptr),
            },
        );
        f.push_inst(
            crate::inst::BlockId::ENTRY,
