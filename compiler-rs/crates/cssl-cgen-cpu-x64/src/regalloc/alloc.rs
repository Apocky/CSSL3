...
use crate::regalloc::interval::{compute_live_intervals, IntervalKind, LiveInterval, ProgramPoint};
use crate::regalloc::reg::{Abi, RegBank, RegRole, X64PReg, X64VReg};
use crate::regalloc::spill::{SpillSlot, SpillSlots};
...
mod alloc_tests {
    use super::*;
    use crate::regalloc::inst::{X64Inst, X64Operand};
