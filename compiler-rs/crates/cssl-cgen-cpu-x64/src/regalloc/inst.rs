...
pub struct X64Func {
    ...
    pub name: String,
    /// Calling convention.
    pub abi: crate::regalloc::reg::Abi,
...
impl X64Func {
    ...
    #[must_use]
    pub fn new(name: impl Into<String>, abi: crate::regalloc::reg::Abi) -> Self {
        Self {
            name: name.into(),
            abi,
            insts: vec![],
...
pub enum VregAssignment {
    ...
    Spill(crate::regalloc::spill::SpillSlot),
...
mod inst_tests {
    use super::*;
    use crate::regalloc::reg::{Abi, RegBank};
