...
//!     - 32-bit ID (`u32`)            — monotonic per [`crate::isel::func::X64Func`].
...
/// [`crate::isel::func::X64Func`] ; the [`X64Width`] drives reg-class + encoding.
///
/// § INVARIANT — id 0 is reserved as null/sentinel. Legitimate vregs start at 1.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Ord, PartialOrd)]
pub struct X64VReg {
    /// 32-bit monotonic id within owning [`crate::isel::func::X64Func`].
    pub id: u32,
...
impl X64VReg {
    ...
    /// Sentinel "null" vreg : `id = 0`. Never produced by [`crate::isel::select::select_function`] ;
