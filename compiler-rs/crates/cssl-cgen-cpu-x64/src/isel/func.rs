...
use super::inst::{BlockId, X64Inst, X64Term};
...
/// A function in [`X64Inst`] form. Output of [`crate::isel::select::select_function`] +
...
#[cfg(test)]
mod tests {
    use super::super::inst::X64Inst;
    use super::super::vreg::{X64VReg, X64Width};
    ...
    fn func_push_inst_appends_to_block() {
        ...
        f.push_inst(
            ...
            X64Inst::MovImm {
                dst: v,
                imm: crate::isel::inst::X64Imm::I32(42),
            },
        );
