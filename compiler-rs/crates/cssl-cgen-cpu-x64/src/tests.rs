...
use crate::inst::{VregAssignment, VregLocation, X64Func, X64Inst, X64Operand};
use crate::interval::{compute_live_intervals, IntervalKind};
use crate::reg::{Abi, RegBank, RegRole, X64PReg, X64VReg};
use crate::spill::SpillSlots;
...
fn alloc_report_totals_match_assignment_count() {
    use crate::alloc::LinearScanAllocator;
