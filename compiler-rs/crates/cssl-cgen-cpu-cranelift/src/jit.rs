...
fn lower_op_to_cl(
    ...
    match op.name.as_str() {
        ...
        "scf.yield" => Ok(false),
        // § T11-D64 (S6-C5) — closure-construction lowering. Stage-0 JIT :
...
/// § T11-D64 (S6-C5) — JIT-side `cssl.closure` no-op binder.
///
...
mod tests {
    ...
    // ─────────────────────────────────────────────────────────────────────
    // § T11-D64 (S6-C5) — closure construction JIT dispatch.
    //
