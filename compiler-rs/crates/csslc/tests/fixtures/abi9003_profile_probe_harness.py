...
expected = {
    ...
    "profile_probe_record_v1": 9001,
    "profile_probe_variant_v1": 9002,
    "profile_probe_known_refusals_v1": 0,
    "profile_probe_all_v1": 9001,
...
print(json.dumps({"status": "PASS", "assertions": len(expected), "probes": actual}, sort_keys=True))
